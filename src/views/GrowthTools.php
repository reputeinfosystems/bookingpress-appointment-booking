<div id="root_app" class="bookingpress-growth_tools bookingpress_page_wrapper">
    ...
    <div class="addons-app-root bookingpress_page_inner_wrapper" v-cloak id="growth-tools-app-root">
        <bp-ui-main class="bpa-main-listing-card-container bpa-default-card bpa--is-page-scrollable-tablet bpa-growth-tools" id="all-page-main-container">	
            <div class="bpa-back-loader-container" id="bpa-page-loading-loader">
                <div class="bpa-back-loader"></div>
            </div>	
            <div id="bpa-main-container">		
                <bp-ui-container class="bpa-growth-tools-container">
                            ...
                            <bp-ui-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="bpa-mlc-left-heading">
                                <div class="bpa-plugin-details-cls">
                                    ...
                                    <div class="bpa-gt-plugin-dec">
                                        ...
                                        <div class="bpa-gt-btn-wrapper" style="margin-top:40px;" >
                                            ...
                                            <?php if ( (is_plugin_active('affiliatepress-affiliate-marketing/affiliatepress-affiliate-marketing.php')) || file_exists( WP_PLUGIN_DIR . '/affiliatepress-affiliate-marketing/affiliatepress-affiliate-marketing.php')  ) { ?>
                                                <bp-ui-button class="bpa-btn bpa-install-btn afp-plugin" disabled="is_disabled">
                                                ...
                                                <?php } else {
                                                    ...
                                                    ?>
                                                    <bp-ui-button class="bpa-btn bpa-install-btn afp-plugin" @click="bpa_download_plugins('affiliatepress')" :class="(is_display_affiliatepress_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                    ...
                                    <div class="bpa-gt-plugin-dec">
                                        ...
                                        <div class="bpa-gt-btn-wrapper" style="margin-top:40px;" >
                                            ...
                                            <?php if ( (is_plugin_active('armember-membership/armember-membership.php')) || file_exists( WP_PLUGIN_DIR . '/armember-membership/armember-membership.php')  ) { ?>
                                                <bp-ui-button class="bpa-btn bpa-install-btn arm-plugin" disabled="is_disabled">
                                                    <span class="bpa-btn__label"> Installed </span> 
                                                <?php } else {
                                                    ...
                                                    //window.location.href = '<?php echo $plugin_install_url; // phpcs:ignore
                                                    ?>
                                                    <bp-ui-button class="bpa-btn bpa-install-btn arm-plugin" @click="bpa_download_plugins('armember')" :class="(is_display_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                                    <span class="bpa-btn__label"> Install </span> 
                                                <?php }  ?>
                                                <div class="bpa-btn--loader__circles">
                                                    <div></div>
                                    ...
                                    <div class="bpa-gt-plugin-dec">
                                        ...
                                        <div class="bpa-gt-btn-wrapper" style="margin-top:40px;" >
                                            <a href="https://www.arformsplugin.com" target="_blank"  class="bpa-learnmore-btn arf-plugin"> Learn More </a>
                                                ...
                                                <bp-ui-button class="bpa-btn bpa-install-btn arf-plugin" disabled="is_disabled">
                                                    <span class="bpa-btn__label"> Installed </span> 
                                                <?php } else {
                                                    ...
                                                    //window.location.href = '<?php echo $plugin_install_url; // phpcs:ignore
                                                    ?>
                                                    <bp-ui-button class="bpa-btn bpa-install-btn arf-plugin" @click="bpa_download_plugins('arforms')" :class="(is_display_arforms_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                                    <span class="bpa-btn__label"> Install </span> 
                                                <?php }  ?>
                                                <div class="bpa-btn--loader__circles">                    
                                                    <div></div>
                                    ...
                                    <div class="bpa-gt-plugin-dec">
                                        ...
                                        <div class="bpa-gt-btn-wrapper" style="margin-top:40px;" >
                                            ...
                                            <?php if ((is_plugin_active('arprice-responsive-pricing-table/arprice-responsive-pricing-table.php')) || file_exists( WP_PLUGIN_DIR . '/arprice-responsive-pricing-table/arprice-responsive-pricing-table.php')  ) { ?>
                                                <bp-ui-button class="bpa-btn bpa-install-btn arp-plugin" disabled="is_disabled">
                                                    <span class="bpa-btn__label"> Installed </span> 
                                                <?php } else {
                                                    ...
                                                    //window.location.href = '<?php echo $plugin_install_url;// phpcs:ignore
                                                    ?>
                                                    <bp-ui-button class="bpa-btn bpa-install-btn arp-plugin" @click="bpa_download_plugins('arprice')" :class="(is_display_arprice_save_loader == '1') ? 'bpa-btn--is-loader' : ''" :disabled="is_disabled">
                                                    <span class="bpa-btn__label"> Install </span> 
                                                <?php }  ?>
                                                <div class="bpa-btn--loader__circles">                    
                                                    <div></div>
