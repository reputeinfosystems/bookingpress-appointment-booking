...
if (! class_exists('BookingPress') ) {
    class BookingPress Extends BookingPress_Core
    {
        ...
        function upgrade_data()
        {
            ...
            if (version_compare($bookingpress_old_version, '1.1.39', '<') ) {
                    ...
                    app = new Vue({
                        ...
                        methods: {
                            ...
                            bookingpress_redirect_sale_premium_page(){
                                window.open('https://www.bookingpressplugin.com/pricing/?utm_source=lite-version&utm_medium=popup&utm_campaign=spring-sale', '_blank');
                            },
        ...
        function set_css()
        {
            ...
            if( !empty( $bpa_sale_popup_details[ $current_year ] ) ){
                ...
                if( $bpa_current_date_for_bf_popup >= $bpa_bf_popup_start_time && $bpa_current_date_for_bf_popup <= $bpa_bf_popup_end_time ){
                    ...
                    if( 'spring_sale' == $sale_type ){
                        wp_add_inline_style( 'bookingpress_admin_custom_css', 'li#toplevel_page_bookingpress ul li:last-child{ background: #E8236F !important; } #toplevel_page_bookingpress ul li:last-child a{ color: white !important; }' );
                    }
                }
            }
        }
